...
public class Programa {
	...
	public static void main(String[] args) { 					//numero , saldo, limite
		...
		System.out.println("Limite disponível: " + c1.getLimite());
		System.out.println("Saldo atual da conta C1: $" + c1.consultarSaldo());
		c1.sacar(600); //o que for alterado aqui vai executar a subtração nos metodos
		c1.depositar(38.90);
		
		System.out.println("------------------------------");
		System.out.println("Conta: " + c2.getNumeroConta());
		System.out.println("Proprietário: " + c2.getNome());
		System.out.println("Limite disponível: " + c2.getLimite());
		System.out.println("Saldo atual da conta C2: $" + c2.consultarSaldo());
		c2.sacar(90);
		c2.depositar(0); //o que for alterado aqui vai executar a soma nos métodos
